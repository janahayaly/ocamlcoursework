...
let test () : bool =
  ...
  truncate 2 q;
  to_list q = [2]
;; run_test "truncate non-empty at head" test
...
let test () : bool =
  ...
  truncate 3 q;
  to_list q = [2; 3]
;; run_test "truncate non-empty from middle" test
...
let test () : bool =
  ...
  truncate 4 q;
  to_list q = [2; 3]
;; run_test "truncate non-empty, enq not found" test

let test () : bool =
  let q = create () in
  truncate 2 q;
  to_list q = []
;; run_test "truncate on empty list" test
...
let test () : bool =
  ...
  delete 3 q;
  to_list q = [2; 4; 5]
;; run_test "delete, one occurence" test
...
let test () : bool =
  ...
  delete 4 q;
  to_list q = [2; 6]
;; run_test "delete, multiple occurence" test
...
let test () : bool =
  ...
  delete 5 q;
  to_list q = []
;; run_test "delete, empty list" test
