...
let test () : bool =
    count_sat_words (set_of_list(["divine"; "fortitude"; "hi"])) = 2
  ;; run_test "count_sat_words: some present" test

let test () : bool =
    count_sat_words (set_of_list(["not"; "in"; "list"])) = 0
  ;; run_test "count_sat_words: non present" test
